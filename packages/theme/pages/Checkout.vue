<template>
  <div v-if="cartGetters.getTotalItems(cart)">
    ...
    <Footer class="footer-fixed" @buttonClick="paymentProceed" :totalPrice="cartGetters.getTotals(cart).total"
      :totalItem="cartGetters.getTotalItems(cart)" :buttonText="'Procéder'" :buttonEnable="proceedToPay">
    ...
    <ModalSlide :visible="shippingAddressModal" @close="toggleShippingModal">
      <AddressInputs :buttonText="`Save Les détails d'expédition`" :headingText="`Les détails d'expédition`"
    ...
    <ModalSlide :visible="billingAddressModal" @close="toggleBillingModal">
      <AddressInputs :buttonText="'Save Détails de la facturation'" :buttonEnable="false"
        :headingText="'Détails de la facturation'" :addressDetails="billingAddress" @getAddress="toggleBillingModal"
        @initCall="initOrder" />
    </ModalSlide>
